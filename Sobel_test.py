...
if __name__ == "__main__":
    test_model(
        model_path="/data/yjy_data/DDBM_GT_Unet/canny_optimization_result/train_result/unet_epoch_100.pth",
        sar_dir="/data/yjy_data/dataset/sen_data_new/testA/",
        opt_dir="/data/yjy_data/dataset/sen_data_new/testB/",
        save_dir="/data/yjy_data/DDBM_GT_Unet/canny_optimization_result/test_result_100_all/",
        batch_size=4
    )

...
def compute_and_save_metrics(*, class_names, save_dir="metrics_out_dual_scyc", prefix="test", logits=None, targets=None):
...
def main():
    ...
    best_acc = 0.0
    best_path = "classification_checkpoints/best_dual_branch_fusion_scyc_res50.pth"
    ...
    for ep in range(1, args.epochs + 1):
        ...
        compute_and_save_metrics(
            ...
            save_dir="metrics_dual_branch_scyc_res50",

...
def main():
    ...
    ) if getattr(args, "use_text_guidance", False) else None
...
def create_argparser():
    defaults = dict(
        ...
        rho=7.0,
        steps=100,
        model_path="/data/yjy_data/DDBM_GT_Unet/logs_S2O_Canny_CAIB_MSFM_scene_text_encoder_0.1/ema_2_0.9999_000500.pt",
        CNW_path="/data/yjy_data/DDBM_GT_Unet/logs_S2O_Canny_CAIB_MSFM_scene_text_encoder_0.1/ema_1_0.9999_000500.pt",

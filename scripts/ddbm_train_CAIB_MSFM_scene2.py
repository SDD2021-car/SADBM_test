...
from SAB.ConvNetworkWithImageFeature_learnable_Canny_Origin import ConvNetworkWithImageFeature as CNW
...
def create_argparser():
    defaults = dict(
        ...
        resume_checkpoint="",
        resume_checkpoint1="/data/yjy_data/DDBM_GT_Unet/scripts/logs_S2O_LoG_CAIB_MSFM_scene_alpha_learnable/ema_2_0.9999_160000.pt",
        resume_checkpoint2="/data/yjy_data/DDBM_GT_Unet/scripts/logs_S2O_LoG_CAIB_MSFM_scene_alpha_learnable/ema_1_0.9999_160000.pt",
        exp='logs_S2O_LoG_CAIB_MSFM_scene_alpha_learnable',
        use_fp16=False,

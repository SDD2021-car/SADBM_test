...
def main():
    ...
    for i, data in enumerate(dataloader):
        ...
        #     tensor2image(x, i)
        save_images_with_filenames(path[200],x0_filename,'/data/yjy_data/DDBM_GT_Unet/result_S2O_Canny_210000')
...
def create_argparser():
    defaults = dict(
        ...
        rho=7.0,
        steps=100,
        model_path="/data/yjy_data/DDBM_GT_Unet/scripts/logs_S2O_Canny_CAIB_MSFM/ema_2_0.9999_210000.pt",
        CNW_path="/data/yjy_data/DDBM_GT_Unet/scripts/logs_S2O_Canny_CAIB_MSFM/ema_1_0.9999_210000.pt",

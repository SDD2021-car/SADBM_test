...
def main(args):
    ...
    if dist.get_rank() == 0:
        ...
        wandb.init(project="SAR2OPT_canny", group=args.exp, name=name, config=vars(args),
...
def create_argparser():
    defaults = dict(
        data_dir="/data/yjy_data/Parallel-GAN-main/Parallel-GAN-main/datasets/sar2opt/combine",
        ...
        resume_checkpoint1="",
        resume_checkpoint2="",
        exp='logs_SAR2OPT_Canny_CAIB_MSFM_central_crop',
        use_fp16=False,

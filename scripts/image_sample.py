...
def main():
    ...
    for i, data in enumerate(dataloader):
        ...
        #     tensor2image(x, i)
        save_images_with_filenames(path[200],x0_filename,'/data/yjy_data/DDBM_GT_Unet/logs_SAR2OPT_0320_SAB_new')
...
def create_argparser():
    defaults = dict(
        data_dir="/data/yjy_data/Parallel-GAN-main/Parallel-GAN-main/datasets/sar2opt/combine", ## only used in bridge
        ...
        rho=7.0,
        steps=100,
        model_path="/data/yjy_data/DDBM_GT_Unet/logs_SAR2OPT_0312_GT_se_SAB/ema_2_0.9999_220000.pt",
        CNW_path="/data/yjy_data/DDBM_GT_Unet/logs_SAR2OPT_0312_GT_se_SAB/ema_1_0.9999_220000.pt",
        exp="logs_SAR2OPT_0312_GT_se_SAB",
        seed=42,
        ts="",
        upscale=False,
        num_workers=2,

...
def main():
    ...
    for i, data in enumerate(dataloader):
        ...
        #     tensor2image(x, i)
        save_images_with_filenames(path[200],x0_filename,'/data/yjy_data/DDBM_GT_Unet/scripts/result_SAR2Opt_CAIB_MSFM_100000')
...
def create_argparser():
    defaults = dict(
        ...
        rho=7.0,
        steps=100,
        model_path="/data/cyh/DDBM_GT_Unet_ablation/scripts/logs_SAR2OPT_CAIB_MSFM/ema_0.9999_100000.pt",
        exp="logs_SAR2OPT_CAIB_MSFM",
        seed=42,
        ts="200",
        upscale=False,
        num_workers=2,

...
def create_argparser():
    defaults = dict(
        ...
        resume_checkpoint="",
        resume_checkpoint1="/data/yjy_data/DDBM_GT_Unet/scripts/logs_S2O_Canny_CAIB_MSFM_scene/ema_2_0.9999_070000.pt",
        resume_checkpoint2="/data/yjy_data/DDBM_GT_Unet/scripts/logs_S2O_Canny_CAIB_MSFM_scene/ema_2_0.9999_070000.pt",
        exp='logs_S2O_Canny_CAIB_MSFM_scene',
        use_fp16=False,

...
if __name__ == "__main__":  # ✅ 只在直接运行时执行
    ...
    train_dataset = SAROptDataset(
        sar_dir="/data/yjy_data/Parallel-GAN-main/Parallel-GAN-main/datasets/sar2opt/trainA/",
        opt_dir="/data/yjy_data/Parallel-GAN-main/Parallel-GAN-main/datasets/sar2opt/trainB/",
        transform=transform
    )
    ...
    num_epochs = 200
    save_dir = "/data/yjy_data/DDBM_GT_Unet/canny_optimization_result_SAR2OPT_v2"

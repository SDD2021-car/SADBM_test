...
def main():
    ...
    parser.add_argument("--backbone_arch", type=str, default="resnet18",
                        choices=["resnet18", "resnet34", "resnet50", "dino", "dinov2"])
    parser.add_argument("--sar_arch", type=str, default="resnet18",
                        choices=["resnet18", "resnet34", "resnet50", "dino", "dinov2"])
    parser.add_argument("--opt_arch", type=str, default="resnet18",
                        choices=["resnet18", "resnet34", "resnet50", "dino", "dinov2"])
    ...
    best_acc = 0.0
    best_path = "classification_checkpoints/best_dual_branch_fusion_cyc.pth"
    ...
    for ep in range(1, args.epochs + 1):
        ...
        compute_and_save_metrics(
            ...
            save_dir="metrics_dual_branch_cyc",
